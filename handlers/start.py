...
from utils.keyboard import start_menu, appeal_menu, onboarding_menu
...
async def start_command(client: Client, message: Message):
    ...
    match_state.user_ui_messages[user_id] = sent.id
    await UserRepository.update(user_id, last_active=int(time.time()))
